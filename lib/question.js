...
//const middleware = require('./nvmiddleware');
...
module.exports = {
    ...
    questionServers.getModule(question.type, (err, questionModule) => {
      ...
      questionModule.generate(question, course, variant_seed, (err, courseIssues, data) => {
        ...
        var variant = {
          ...
          variant_id: data.variant_number,
          total_variants: 100,
        };
  ...
  _buildQuestionUrls(urlPrefix, variant, question, instance_question, assessment) {
    ...
    if (!assessment) {
      ...
      urls.nextVariantUrl = questionUrl + 'preview/' + 'nextVariant';
      urls.prevVariantUrl = questionUrl + 'preview/' + 'prevVariant';
